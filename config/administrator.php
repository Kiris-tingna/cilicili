...
return array(
	 ...
	 */
	'menu' => array(
        // 对应需要创建的文件：config/administrator/users.php
		'用户管理' => array('users'),
        // 对应需要创建的文件：`config/administrator/posts.php`
        '内容管理' => array('categories', 'posts', 'videos', 'specials'),
        // 对应需要创建的文件：`config/administrator/settings/site.php`
        '后台设置' => array('settings.site')
    ),
